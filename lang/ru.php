...
class LangRu extends iLang { 
  ...
  public $translate = array (
    ...
    231 => "Выполненные",
    232 => "Плановая дата",
    233 => "Фактическая дата",
    234 => "Приоритет",
    235 => "Выполнить цель",
    236 => "Удалить цель?",
    237 => "Перейти к предыдущему периоду",
    238 => "Перейти к следующему периоду",
    239 => "XLSX",
    240 => "Добавить покупки из XLSX выгрузки интернет банка",
    241 => "Загрузить",
    242 => "API чека по ФПД",
    243 => "Чек уже существует, добавить еще раз?"
  );
